import { IValidator, IValidationError, IValidationResult, Action, Func, Func2, IRuleSetValidator, IRuleSetValidatorBase, IDateRuleSetValidator, IStringRuleSetValidator } from './ivalidator';
...
class StringRuleSetValidator<T> extends RuleSetValidatorBase<T, string> implements IStringRuleSetValidator<T> {               
...
class DateRuleSetValidator<T> extends RuleSetValidatorBase<T, Date> implements IDateRuleSetValidator<T> {               
